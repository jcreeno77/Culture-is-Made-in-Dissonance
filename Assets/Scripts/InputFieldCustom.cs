...
//MAJREF refers to Major References
...
namespace TMPro
{
    ...
    public class InputFieldCustom : Selectable,
        ...
        IScrollHandler
    {
        ...
        protected EditState KeyPressed(Event evt)
        {
                ...
                case KeyCode.KeypadEnter:
                    {
                        ...
                        if (placeHolder.GetComponent<TextMeshProUGUI>().text == text)
                        {
                            //MAJREF
                            //DO STUFF HERE AFTER ENTER PRESSED
                            mainCam.GetComponent<EventManager>().entPressValid = true;
                            Debug.Log(text);
            ...
            if (IsValidChar(c))
            {
                Mathf.Clamp(counter, 0, placeHolder.GetComponent<TextMeshProUGUI>().text.Length);
                if (placeHolder.GetComponent<TextMeshProUGUI>().text[counter] == c)
                {
                    counter += 1;
                    Append(c);
                }
